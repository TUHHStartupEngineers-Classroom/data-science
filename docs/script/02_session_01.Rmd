# (PART) Session 2 {-}
#  `r fa("r-project", fill = "black")` Data visualization with ggplot {#session_01_02}
<a href="https://ggplot2.tidyverse.org">
<img src="input/session_02/01_images/logo_ggplot2.svg" align="right" style="width:250px; height:250px; padding:10px"/>
</a>
...
## **VISUALIZE** - Introduction To Visualization In ggplot2


## Adding Complexity To Visualizations

## Customizing Your Plots
<!-- set global eval FALSE so that all chunks will not be evaluated  -->

<!-- Load package to display fontawesome icons -->
...
```{r sakila, echo=FALSE, fig.cap='sakila db', out.width='100%'}
knitr::include_graphics('input/session_02/01_images/sakila_db.png', dpi = NA)
```