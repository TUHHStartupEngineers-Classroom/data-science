...
Getting set up: Create a new project and organize your working directory
...
4. Under the Files tab on the right of the screen, click on New Folder and create a folder named `00_getting_started` within your newly created working directory (e.g., ~/Dropbox/data-science). (Alternatively, type `dir.create("00_getting_started")` at your R console.) 

5. Open your R-script and save it in this directory.
