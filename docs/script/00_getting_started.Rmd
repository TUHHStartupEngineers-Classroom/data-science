...
To create an object, we need to give it a name followed by the assignment operator `<-`, and the value we want to give it next to it. Typing <kbd>Cmd</kbd> + <kbd>-</kbd> will write `<-` in a single keystroke. Spaces are optional around assignment operators.
