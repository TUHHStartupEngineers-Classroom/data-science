...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Script for the Class DS101},
...
\title{Script for the Class DS101}
...
\hypertarget{intro}{%
\chapter{Getting started with R and RStudio}\label{intro}}
...
\subsection{Workspace Environment}\label{workspace-environment}}

\hypertarget{misc.-displays}{%
\subsection{Misc. Displays}\label{misc.-displays}}
...
\item
  Create a folder on your computer titled Learning R. Within R, set your working directory to this folder.
\end{enumerate}

\hypertarget{working-with-packages}{%
...
\hypertarget{part-statisticts-with-r}{%
\part{Statisticts with R}\label{part-statisticts-with-r}}
